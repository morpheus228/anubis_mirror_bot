...
class ClientsService(Clients):
	...
	def give(self, name: str, session_string: str, requests_balance: int):
		self.repository.update_by_name(name, is_used_by=None, session_string=session_string, requests_balance=requests_balance)
